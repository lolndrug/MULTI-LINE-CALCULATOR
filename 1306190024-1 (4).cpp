...
// NOTE1:ÝNPUT dosyalarýnýn adý "Challange" olarak  yazýlmýþtý ,deðiþtirmedim.
// Sizden saðlýk sorunlarým nedeniyle ödev için ek süre istemiþtim lakin bitirdiðim yere(Challange6.inp) kadar olan kýsmýný vaktinde göndermeye karar verdim.
// Yine de ek süre verdiðiniz ve anlayýþlý davrandýðýnýz için teþekkür ederim.
